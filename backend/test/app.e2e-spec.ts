...
describe('AppController (e2e)', () => {
  ...
  const expected_tshirts_outputs = {
    "en-US": '[{"group":"kids","items":[{"id":1,"name":"kid_3-4"},{"id":2,"name":"kid_5-6"},{"id":3,"name":"kid_7-8"},{"id":4,"name":"kid_9-11"},{"id":5,"name":"kid_12-14"}]},{"group":"adults","items":[{"id":6,"name":"adult_XXS"},{"id":7,"name":"adult_XS"},{"id":8,"name":"adult_S"},{"id":9,"name":"adult_M"},{"id":10,"name":"adult_L"},{"id":11,"name":"adult_XL"},{"id":12,"name":"adult_XXL"},{"id":13,"name":"adult_3XL"},{"id":14,"name":"adult_4XL"},{"id":15,"name":"adult_5XL"}]}]',
    "nl-BE": '[{"group":"kind","items":[{"id":1,"name":"kind_3-4"},{"id":2,"name":"kind_5-6"},{"id":3,"name":"kind_7-8"},{"id":4,"name":"kind_9-11"},{"id":5,"name":"kind_12-14"}]},{"group":"volwassen","items":[{"id":6,"name":"volwassen_XXS"},{"id":7,"name":"volwassen_XS"},{"id":8,"name":"volwassen_S"},{"id":9,"name":"volwassen_M"},{"id":10,"name":"volwassen_L"},{"id":11,"name":"volwassen_XL"},{"id":12,"name":"volwassen_XXL"},{"id":13,"name":"volwassen_3XL"},{"id":14,"name":"volwassen_4XL"},{"id":15,"name":"volwassen_5XL"}]}]',
    "fr-BE": '[{"group":"enfants","items":[{"id":1,"name":"enfants_3-4"},{"id":2,"name":"enfants_5-6"},{"id":3,"name":"enfants_7-8"},{"id":4,"name":"enfants_9-11"},{"id":5,"name":"enfants_12-14"}]},{"group":"adulte","items":[{"id":6,"name":"adulte_XXS"},{"id":7,"name":"adulte_XS"},{"id":8,"name":"adulte_S"},{"id":9,"name":"adulte_M"},{"id":10,"name":"adulte_L"},{"id":11,"name":"adulte_XL"},{"id":12,"name":"adulte_XXL"},{"id":13,"name":"adulte_3XL"},{"id":14,"name":"adulte_4XL"},{"id":15,"name":"adulte_5XL"}]}]'
  }
  ...
  const expected_questions_outputs = {
    "en-US": '[{"id":1,"name":"Agree to Photo","description":"It is possible that the participant is photographed or filmed","positive":"That is no problem","negative":"Don\'t use any pictures or movies where the participant is reconizable"},{"id":2,"name":"Agree to Contact","description":"Can CoderDojo contact you for the next edition","positive":"Yes","negative":"No"}]',
    "nl-BE": '[{"id":1,"name":"Agree to Photo","description":"Het is mogelijk dat de deelnemer gefotografeerd of gefilmd wordt","positive":"Dat is geen probleem","negative":"Gelieve geen foto’s en filmpjes te gebruiken waarop de deelnemer herkenbaar is"},{"id":2,"name":"Agree to Contact","description":"Mag CoderDojo je contacteren voor de volgende editie?","positive":"Ja","negative":"Nee"}]',
    "fr-BE": '[{"id":1,"name":"Agree to Photo","description":"Le ou la participant.e peut être photographié.e ou filmé.e.","positive":"Je suis d\'accord","negative":"Je ne suis pas d’accord que l’on utilise les images et vidéos si le ou la participant.e est reconnaissable"},{"id":2,"name":"Agree to Contact","description":"CoderDojo peut-il vous contacter pour la prochaine édition ?","positive":"Qui","negative":"Non"}]'
  }
  ...
  const expected_approvals_outputs = {
    "en-US": '[{"id":3,"name":"Approved","description":"Be sure to read our rules. Do you agree"}]',
    "nl-BE": '[{"id":3,"name":"Approved","description":"Lees zeker onze regels. Ga je akkoord?"}]',
    "fr-BE": '[{"id":3,"name":"Approved","description":"Assure-toi de lire nos règles. Es-tu d\'accord ?"}]'
  }
